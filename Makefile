...
ARCH	= arm64
CROSS_COMPILE = /home/rissu/env/google/bin/aarch64-linux-android-
...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
CC              = /home/rissu/env/clang-11/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /home/rissu/env/gnu/bin/aarch64-linux-gnu-
